...
export default (restart, imageSource) => { 
    ...
    const shouldAddWoofer = Math.random() < 0.05
    ...
    return {
        ...
        ...(shouldAddWoofer && {
            Woofer: Obstacle(world, 'Woofer', 'black', { x: windowWidth +50, y: getRandom(windowHeight * 0.7, windowHeight)}, { height: 160, width: 160 }, require('../assets/rcSgtWoofer.png'))
        })
    }
}