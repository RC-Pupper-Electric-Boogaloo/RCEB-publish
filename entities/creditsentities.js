...
export default async (restart, imageSource) => {
    ...
    const allEntities = [
        ...
        { id: 12, name: "Bonus Pupper", source: require("../assets/rcBonusPuppy.png"), x: 0.1, y: 0.81, message: "You get a pupper, and you get a pupper! What's better than one pupper? Another pupper as a bonus! This feisty little Chihuahua knows how to throw a party!" },
        { id: 9, name: "Golden Puppy", source: require("../assets/rcGentlePuppy.png"), x: 0.4, y: 0.81, message: "Who do you call when gold needs retrieving? This Golden Puppy is a true gentleman. With aristocratic charm, this Golden Retriever puppy shines like 10,000 golden coins. You've been through some bonus modes to unlock this fella, haven't you?" },
        { id: 14, name: "Merchant Beagle", source: require("../assets/rcMeclarBeagle.png"), x: 0.7, y: 0.81, message: "It's the trade that's worth it! Once this Merchant notarized every puppy adoption at the Puppy Pawn Shop, what else was there to do but join the fun? Merchant Beagle can do so much more than just trading!" },
        { id: 21, name: "Tibetan Tycoon", source: require("../assets/rcTibetanTycoon.png"), x: 0.93, y: 0.78, message: "With a gleaming monocle and a sack brimming with gold coins, the Tibetan Tycoon knows the true value of shiny treasures. This sophisticated Tibetan Spaniel doesn't bother with bones—it's all about the riches. Look out, world—this pup means business!" },
        ...
        { id: 13, name: "Sergeant Woofer", source: require("../assets/rcSgtWoofer.png"), x: 0.5, y: 0.84, message: "Master of disguise! How did you even find Woofer? This fluffy Lapland dog can camouflage anywhere. Can you even see the Sergeant? Cats sure can't!" },
        ...
        { id: 4, name: "Saint Bernard", source: require("../assets/rcBreakBernard.png"), x: 0.85, y: 0.89, message: "Need a break? Saint Bernard's got you covered with a keg full of warm cocoa! This lovable pup knows how to keep things cozy and relaxed, ensuring you take a well-deserved pause. Just don't forget the marshmallows!" },
        { id: 17, name: "Fluffers", source: require("../assets/rcFluffers.png"), x: 0.15, y: 0.89, message: "Who's buried in the snow with only a nose poking out? Fluffers!!! This ultra-fluffy pup might get lost in a snowdrift, but don't worry—it always comes back for a cozy cuddle. Just keep an eye on that fluffy tail!" },
