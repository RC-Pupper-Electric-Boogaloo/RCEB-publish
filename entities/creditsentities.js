...
export default async (restart, imageSource) => {
    ...
    const allEntities = [
        { id: 14, name: "OG RC Pupper", source: require("../assets/rcPupperOg.png"), x: 0.85, y: 0.72, message: "Blast from the past! The Original RC Puppy didn't ride a remote-controlled car—no, no, no. It was the remote-controlled Puppy, full of electric boogaloo. Classic mode offers a glimpse of how things could have been." },
        ...
        { id: 6, name: "Business Borzoi", source: require("../assets/rcBusinessBorzoi.png"), x: 0.45, y: 0.75, message: "Why the long face? Business Borzoi has his snout deep in work. At least the commute goes fast with brand new rc car." },
        { id: 4, name: "Win Whippet", source: require("../assets/rcWinWhippet.png"), x: 0.75, y: 0.75, message: "This puppy just can't stop winning! A medal hangs proudly around its neck, proving to other puppies that it's the best. Hitting speeds of 60 mph without a remote-controlled car—and going even faster with one—nobody can catch this speedster. Whip it, Win Whippet!" },
