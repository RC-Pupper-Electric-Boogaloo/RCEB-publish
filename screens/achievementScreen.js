...
const AchievementScreen = ({ navigation }) => {
    ...
    const achievementList = [
        ...
        { id: 4, name: "Howling Success!", requirement: "Collect over 100 points in a single game", image: require('../assets/Cat.png'), progress: 0, goal: 100, unlocked: false },
    ]
    ...
    const handleAchievementClick = (achievement) => {
        if (!achievement.unlocked) {
            ...
            Alert.alert("Achievement Unlocked",
                `GZ! You unlocked the achievement: "${achievement.name}".`)
        }
    }

    const achievementProgress = (achievementId, increment) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.Guidecontainer}>
            ...
            {achievements.map((achievement) => (
                ...
                >
                    <Image source={achievement.image} style={[ styles.Guideimage, { opacity: achievement.unlocked ? 1 : 0.3 },
                         ]}
                     />
